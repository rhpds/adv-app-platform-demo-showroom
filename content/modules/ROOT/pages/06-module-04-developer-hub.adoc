...
NOTE: The demo environment relies on a relatively small AI model that might not provide ideal answers for certain prompts. Larger models provide faster and more detailed responses, and make better use of the available Model Context Protocol tools available to inspect the RHDH catalog. 
