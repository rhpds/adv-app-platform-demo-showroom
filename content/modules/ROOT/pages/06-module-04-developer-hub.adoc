...
[WARNING]
====
LLMs are non-deterministic — responses vary between attempts. The demo environment uses a relatively small model (`qwen3-14b`). Before issuing prompts:

* Ensure `qwen3-14b` is selected in the model selection drop-down (upper right of the Lightspeed interface). Other models may be listed but will not produce meaningful results.
