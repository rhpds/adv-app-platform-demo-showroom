...
. Confirm software templates are available in the "Create" section (look for the _Parasol Insurance Secured Development_ template and the _Quarkus Application_ template). Do not pre-bump `backstage.io/template-version` on Quarkus Application — Module 4 Part 4 needs Developer Hub to observe a live version increase.
