...
. (Optional) Demonstrate **fault injection** to show how the mesh helps test application resilience:
...
* After demonstrating, remove the fault injection by clicking the three-dot menu again, selecting **Delete**, and confirming
