...
* **AI/ML workloads** — Applications consume LLM endpoints as API calls; models can run on-premises with Red Hat AI (RHEL AI or OpenShift AI) or through hosted providers, and integrate seamlessly with the application platform
...
And for organizations looking to adopt AI, this platform is the foundation. The same automated pipelines, GitOps practices, and observability tools apply to AI workloads. Whether the LLM runs on-premises with Red Hat AI or through a hosted provider, the application platform treats it as an API endpoint that any component can consume.
...
. **Module 3: Platform operations** — mTLS encryption and traffic policy management with Service Mesh, real-time observability through traffic graphs and workload monitoring, customizable dashboards and alerts, and broader platform capabilities
