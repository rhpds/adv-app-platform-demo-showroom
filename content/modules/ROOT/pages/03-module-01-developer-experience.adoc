...
* DevSpaces will establish a connection (OAuth) to GitLab to pull and eventually push code, you'll need to again supply your username (`dev1`) and password (`{password}`) to authenticate the connection.
