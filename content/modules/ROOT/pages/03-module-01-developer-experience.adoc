...
. Show how a platform engineer can add a custom sample workspace to the DevSpaces "Create Workspace" screen. This gives developers a curated set of starting points beyond the default devfile registry:
...
// TODO: Add screenshot showing the new sample in the DevSpaces Create Workspace screen
