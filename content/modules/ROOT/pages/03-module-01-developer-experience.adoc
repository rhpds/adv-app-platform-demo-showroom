...
* "The platform engineer just published a new workspace sample that gives any developer a fully private AI coding assistant running Ollama inside DevSpaces. No code leaves the cluster. Developers see this as a one-click option when creating a new workspace. This is how the platform team curates the developer experience."
+
